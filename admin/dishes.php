...
$stmt = $db_con->prepare("SELECT * FROM dishes ");
$stmt->execute();
...
echo' 
<tr>
											<td>'.$stmtRow['dish_id'].'</td>
											<td><img src="dishes/'.$stmtRow['dish_image'].'" alt="'.$stmtRow['dish_name'].'" width="42" height="42" class="rounded-circle"></td>
											<td>'; echo $stmtRow['dish_name']; echo'</td>
											<td>'.$stmtRow['dish_class'].'</td>
											<td>'.$stmtRow['meal_type'].'</td>
											<td>'.$stmtRow['dish_type'].'</td>
											<td>$30,000</td>
											<td>2010</td>
