      ...
      <div class="container">
        <div class="section-content">
          <div class="swin-sc swin-sc-title style-2">
            <h3 class="title"><span>Register</span></h3>
          </div>
          <div class="reservation-form">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                <p class="reservation-form-title text-center">We willing to help you make the reservation online to
                  save your time and money or you can call us directly through the customer service hotline:<a href="login.php" ><span class="text-default">
                    Login</span></a></p>
              </div>
            </div>
            <div class="swin-sc swin-sc-contact-form light mtl">
            
            <!--form class="" method="post" id="register-form">
        ...
        <div class="input-group col-md-5">
                    ...
                    <input type="email" class="form-control input-group-addon" placeholder="Email address" name="user_email_address" id="user_email_address" />
        <span id="check-e"></span>
                  </div>
        ...
        <div class="input-group col-md-5">
                    ...
                    <input type="password" class="form-control input-group-addon" placeholder="Password" name="password" id="password" />
        <!--span id="check-e"></span- ->
                  </div>
        ...
        <div class="form-group">
    		...
    		<span class="glyphicon glyphicon-log-in"></span> &nbsp; Register Now	</button> 
...
<!--div class="swin-btn-wrap center"><a href="#" class="swin-btn center form-submit"> <span>Sign In</span></a></div- ->
      ...
      <!--div class="form-group"> 
      <input type="text" class="form-control" placeholder="Fullname" name="userfullname" id="userfullname" />
      <span id="check-e"></span>
      </div-->
      ...
      <!--div class="form-group">
      <input type="email" class="form-control" placeholder="User email" name="user_email" id="user_email" />
      <span id="check-e"></span>
      </div-->
<br>
        <div class="input-group col-md-8">
      ...
      <input type="text" class="form-control" placeholder="user address" name="user_address" id="user_address" />
      <span id="check-e"></span>
      </div>
      ...
      <input type="text" class="form-control" placeholder="user location" name="user_location" id="user_location" />
      <span id="check-e"></span>
</div>
      ...
      <input type="phone" class="form-control" placeholder="user phone" name="user_phone" id="user_phone" />
      <span id="check-e"></span>
      </div
     <hr />
